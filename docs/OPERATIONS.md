...
3. Extract the matching new edition and install using a fresh absolute `--prefix`. For example, a future version could use `$HOME/.local/share/nodepeek-1.4.1` or `/opt/nodepeek-1.4.1`.
